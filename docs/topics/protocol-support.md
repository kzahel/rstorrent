...
| [BEP 52: The BitTorrent Protocol Specification v2](https://www.bittorrent.org/beps/bep_0052.html) | Unsupported | Metainfo and magnet parsers explicitly reject v2 and hybrid identities. Completed Tactical [`143`](../tactical/143-dual-identity-and-persistence-foundation.md) adds full typed identity slots, an opaque stable owner, explicit versioned wire projection, and replacement persistence/artifact ownership while preserving those rejections. | No v2 input, file tree, piece layer, Merkle verification, hash exchange, hybrid negotiation, or v2 swarm behavior exists. The accepted [`bittorrent-v2-and-hybrid`](bittorrent-v2-and-hybrid.md) topic owns those later slices. |
