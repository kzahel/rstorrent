...
bounded physical UDP-readiness gate closes evidence-limited with exact cleanup,
so the **Partial** claim remains and public incoming uTP is not claimed.
