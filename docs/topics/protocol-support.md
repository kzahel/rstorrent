...
path. UDP trackers and DHT now advertise the selected TCP endpoint for an
eligible completed seed. It does not claim complete BEP 3 or BEP 5 support,
public-swarm advertisement reliability, incomplete-torrent upload policy,
HTTP trackers, uTP, or v2 support.
