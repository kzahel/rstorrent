...
| [BEP 52: The BitTorrent Protocol Specification v2](https://www.bittorrent.org/beps/bep_0052.html) | Unsupported | Metainfo and magnet parsers explicitly reject v2 and hybrid identities. Completed Tactical [`143`](../tactical/143-dual-identity-and-persistence-foundation.md) adds full typed identity slots, an opaque stable owner, explicit versioned wire projection, and replacement persistence/artifact ownership while preserving those rejections. Active Tactical [`146`](../tactical/146-runtime-free-bep52-metainfo-geometry-merkle.md) is implementing the runtime-free parser, geometry, piece-layer, and Merkle foundation without changing product admission. | No accepted v2 input, piece-layer payload verification, hash exchange, hybrid negotiation, or v2 swarm behavior exists. Runtime-free parsing and vectors will not by themselves advance this claim; the accepted [`bittorrent-v2-and-hybrid`](bittorrent-v2-and-hybrid.md) topic owns the vertical slices. |
