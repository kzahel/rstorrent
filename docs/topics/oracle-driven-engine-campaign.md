...
passes with the recorded tray limitation. Tactical 214 now implements
dependency/advisory review, five-target notices
...
lifetime and proves one-at-a-time, paced replacement of a zero-contribution
metadata worker only while all 30 cohort slots are occupied and an eligible
candidate waits. Contributing and sparse peers remain protected, controlled
pinned-libtorrent metadata interop passes, and both Android ABIs build.
Completed Tactical
