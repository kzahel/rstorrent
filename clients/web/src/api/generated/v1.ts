...
export type ClientSettings = { listener: ListenerPolicy, preferred_listen_port: number, port_mapping: PortMappingPolicy, peer_connection_limit: number, upload_slots: number, encryption: EncryptionPolicy, ipv6_enabled: boolean, tracker_https_server_authentication: HttpsServerAuthenticationPolicy, };
