...
export const MANIFEST_NAME = "rstorrent-crostini-release.manifest";
export const SIGNATURE_NAME = "rstorrent-crostini-release.manifest.minisig";
export const LAUNCH_PROTOCOL_VERSION = 1;
export const EXTENSION_ID = "gcgoepclopkgijmclmlheafaglmbjlcc";
export const REPOSITORY = "kzahel/rstorrent";
export const RUNTIME = "linux-gnu-crostini-package";
...
function describeAsset(filePath, arch, version) {
  const expectedName = `rstorrent-crostini-${version}-${arch}.tar.gz`;
...
function main() {
  ...
  if (
    ...
    throw new Error(
      "usage: write-crostini-release-manifest.mjs <version> <commit> <x86_64-package> <aarch64-package> <output>",
    );
  }
  writeFileSync(
    outputPath,
