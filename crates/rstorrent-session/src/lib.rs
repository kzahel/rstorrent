...
pub use views::{
    ...
    FileRowUpdate, IndexRange, OpenViewSetOptions, OpenViewSetRequest, OpenViewSetResponse,
    ...
    SwarmPeerView, TorrentEtaView, TorrentFieldUpdate, TorrentOperationalState, TorrentRowUpdate,
    TorrentView, TorrentViewChange, UpdateBatch, UpdateViewSetRequest, VIEW_CONTRACT_VERSION,
